...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'checkout.subtitle': 'Starten Sie mit einer 14-tägigen kostenlosen Testversion',
    'checkout.monthly': 'Monatlich',
    'checkout.yearly': 'Jährlich',
    'checkout.popular': 'Beliebt',
    'checkout.custom': 'Individuell',
    'checkout.perMonth': 'Monat',
    'checkout.billedYearly': 'jährlich abgerechnet',
    'checkout.continue': 'Weiter zur Zahlung',
    'checkout.processing': 'Wird verarbeitet...',
    'checkout.redirecting': 'Sie werden zur Zahlungsseite weitergeleitet...',
    'checkout.testCard': 'Testkarte',
    'checkout.success.title': 'Zahlung erfolgreich!',
    'checkout.success.message': 'Vielen Dank für Ihre Bestellung. Ihr Abonnement ist jetzt aktiv.',
    'checkout.success.dashboard': 'Zum Dashboard',
    'checkout.success.email': 'Eine Bestätigung wurde an Ihre E-Mail-Adresse gesendet.',
    'checkout.cancel.title': 'Zahlung abgebrochen',
    'checkout.cancel.message': 'Die Zahlung wurde abgebrochen. Sie können es jederzeit erneut versuchen.',
    'checkout.cancel.retry': 'Erneut versuchen',
    'checkout.cancel.home': 'Zur Startseite',
    
    // Demo Request
    'demo.title': 'Demo anfordern',
    'demo.subtitle': 'Füllen Sie das Formular aus und wir melden uns bei Ihnen.',
    'demo.company': 'Unternehmen',
    'demo.name': 'Ihr Name',
    'demo.email': 'E-Mail',
    'demo.phone': 'Telefon (optional)',
    'demo.employees': 'Anzahl Mitarbeiter',
    'demo.country': 'Land',
    'demo.message': 'Nachricht (optional)',
    'demo.submit': 'Demo anfordern',
    'demo.success': 'Vielen Dank! Wir melden uns in Kürze bei Ihnen.',
  },
  en: {
    // Navigation
    ...
    'checkout.subtitle': 'Start with a 14-day free trial',
    'checkout.monthly': 'Monthly',
    'checkout.yearly': 'Yearly',
    'checkout.popular': 'Popular',
    'checkout.custom': 'Custom',
    'checkout.perMonth': 'month',
    'checkout.billedYearly': 'billed yearly',
    'checkout.continue': 'Continue to Payment',
    'checkout.processing': 'Processing...',
    'checkout.redirecting': 'Redirecting to payment page...',
    'checkout.testCard': 'Test card',
    'checkout.success.title': 'Payment Successful!',
    'checkout.success.message': 'Thank you for your order. Your subscription is now active.',
    'checkout.success.dashboard': 'Go to Dashboard',
    'checkout.success.email': 'A confirmation has been sent to your email.',
    'checkout.cancel.title': 'Payment Cancelled',
    'checkout.cancel.message': 'The payment was cancelled. You can try again anytime.',
    'checkout.cancel.retry': 'Try Again',
    'checkout.cancel.home': 'Go Home',
    
    // Demo Request
    'demo.title': 'Request Demo',
    'demo.subtitle': 'Fill out the form and we will get back to you.',
    ...
    'demo.success': 'Thank you! We will get back to you shortly.',
  },
  hr: {
    // Navigation
    ...
    // Checkout
    'checkout.back': 'Natrag',
    'checkout.title': 'Odaberite svoj plan',
    'checkout.subtitle': 'Započnite s 14-dnevnim besplatnim probnim razdobljem',
    'checkout.monthly': 'Mjesečno',
    'checkout.yearly': 'Godišnje',
    'checkout.popular': 'Popularno',
    'checkout.custom': 'Individualno',
    'checkout.perMonth': 'mjesec',
    'checkout.billedYearly': 'godišnje naplaćeno',
    'checkout.continue': 'Nastavi na plaćanje',
    'checkout.processing': 'Obrada...',
    'checkout.redirecting': 'Preusmjeravanje na stranicu za plaćanje...',
    'checkout.testCard': 'Testna kartica',
    'checkout.success.title': 'Plaćanje uspješno!',
    'checkout.success.message': 'Hvala na narudžbi. Vaša pretplata je sada aktivna.',
    'checkout.success.dashboard': 'Idi na nadzornu ploču',
    'checkout.success.email': 'Potvrda je poslana na vašu e-mail adresu.',
    'checkout.cancel.title': 'Plaćanje otkazano',
    'checkout.cancel.message': 'Plaćanje je otkazano. Možete pokušati ponovo bilo kada.',
    'checkout.cancel.retry': 'Pokušaj ponovo',
    'checkout.cancel.home': 'Idi na početnu',
    
    // Demo Request
    'demo.title': 'Zatraži demo',
    'demo.subtitle': 'Ispunite obrazac i javit ćemo vam se.',
    'demo.company': 'Tvrtka',
    'demo.name': 'Vaše ime',
    'demo.email': 'E-mail',
    'demo.phone': 'Telefon (opcionalno)',
    'demo.employees': 'Broj zaposlenika',
    'demo.country': 'Država',
    'demo.message': 'Poruka (opcionalno)',
    'demo.submit': 'Zatraži demo',
    'demo.success': 'Hvala! Javit ćemo vam se uskoro.',
  },
};
